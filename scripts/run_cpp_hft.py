...
result = {
    ...
    "timeframe": "M1", "period": "2025-01-01 to 2025-12-31", "rows": int(len(close)),
    "performance": {"elapsed_ms": round(elapsed*1000, 2), "bars_per_sec": int(len(close)/elapsed), "total_return_pct": round(float(total_ret*100), 2), "sharpe": round(float(sharpe), 3), "max_drawdown_pct": round(float(max_dd*100), 2), "win_rate_pct": round(float(win_rate), 2)},
