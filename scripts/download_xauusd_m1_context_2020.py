...
FINAL_CSV = OUTPUT_DIR / "XAUUSD_M1_2020_context_MT5.csv"
MANIFEST_JSON = OUTPUT_DIR / "XAUUSD_M1_2020_context_MT5.manifest.json"

# ÃƒÂÃ‚Â¡ÃƒÂÃ‚Â°Ãƒâ€˜Ã¢â€šÂ¬Ãƒâ€˜Ã¢â‚¬Â¹ÃƒÂÃ‚Â½ chunk.
CHUNK_DAYS = 31

# MT5 history server/cache ÃƒÂÃ‚Â·ÃƒÂÃ‚Â°Ãƒâ€˜Ã¢â€šÂ¬ÃƒÂÃ‚Â¸ÃƒÂÃ‚Â¼ÃƒÂÃ‚Â´ÃƒÂÃ‚Â°ÃƒÂÃ‚Â° Ãƒâ€˜Ã‹â€ Ãƒâ€˜Ã†â€™Ãƒâ€˜Ã†â€™ÃƒÂÃ‚Â´ ÃƒÂÃ‚Â±Ãƒâ€™Ã‚Â¯Ãƒâ€˜Ã¢â‚¬Â¦ data-ÃƒÂÃ‚Â³ Ãƒâ€œÃ‚Â©ÃƒÂÃ‚Â³Ãƒâ€œÃ‚Â©Ãƒâ€˜Ã¢â‚¬Â¦ÃƒÂÃ‚Â³Ãƒâ€™Ã‚Â¯ÃƒÂÃ‚Â¹.
MAX_RETRIES = 5
RETRY_SECONDS = 3
...
def validate_final(df: pd.DataFrame) -> dict:
    ...
    passed = (
        ...
        and report["invalid_volume_flags"] == 0
        and report["invalid_spread_rows"] == 0
    )
