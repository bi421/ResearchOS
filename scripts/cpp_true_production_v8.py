...
print("=" * 70)
print("🚀 TRUE PRODUCTION v8: Комисс ажиллагаатай SMA")
print("=" * 70)
...
commissions = [0.0005, 0.001, 0.0015, 0.002]  # 0.05% -> 0.20%
results = []
...
for h in timeframes:
    ...
    for t in commissions:
        try:
            # ✅ Комисс дамжуулах (хэрэв run_sma-д commission параметр байгаа бол)
            try:
                result = engine.run_sma(20, 50, commission=t)
            except TypeError:
                # Хэрэв commission параметр байхгүй бол өгөгдмөл
...
output_file = "data/curated/xauusd/phase51_m1_cpp_true_production_v8.json"
