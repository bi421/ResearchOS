            ...
            self.issues.append(
                {
                    ...
                    "severity": "high",
                    "description": f"Загвар {model_worse}/{total} тохиолдолд суурь шугамаас муу",
            ...
            self.issues.append(
                {
                    ...
                    "severity": "critical",
                    "description": f"Загвар {model_equal}/{total} тохиолдолд суурь шугамтай ижил (majority class)",
