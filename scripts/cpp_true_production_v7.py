...
print("=" * 70)
print("🚀 TRUE PRODUCTION v7: CppQuant + run_sma (V3 ажилласан арга)")
print("=" * 70)
...
for h in timeframes:
    ...
    for t in commissions:
        try:
            # ✅ V3 дээр ажилласан арга: run_sma(20, 50)
            result = engine.run_sma(20, 50)

            # Winrate-г зөв масштаблах (V3 дээр 3528% гарч байсан)
...
# 3. Хадгалах
output_file = "data/curated/xauusd/phase51_m1_cpp_true_production_v7.json"
