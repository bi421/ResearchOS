...
print("=" * 70)
print("🚀 TRUE PRODUCTION v6: CppQuant + load_from_dataframe + winrate зассан")
print("=" * 70)
...
for h in timeframes:
    ...
    # ✅ C++ engine-г шинээр үүсгэх (өгөгдөл бүрт)
    engine = CppQuant()
    ...
    for t in commissions:
        try:
            ...
            # ✅ Winrate-г зөв масштаблах (0-1 хооронд байлгах)
...
output_file = "data/curated/xauusd/phase51_m1_cpp_true_production_v6.json"
