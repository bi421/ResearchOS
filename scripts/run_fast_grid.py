...
from researchos.ml_engine.model import train_model, predict
...
# Grid search – threshold бүрт стратеги дахин үүсгэх боловч create_features-г давтахгүй
# Бид custom generate_signals-тэй strategy классыг ашиглана.
class FastMLStrategy(MLStrategy):
    def generate_signals(self, prices):
        # Өгөгдсөн prices-г үл тоомсорлож, өмнө тооцоолсон df_feat болон probs-г ашиглана.
        signals = []
        # df_feat-ийн индексүүдээр давтах
...
for th in thresholds:
    ...
    # generate_signals нь өгөгдсөн prices-г үл тоомсорлож, кэшлэгдсэн өгөгдөл ашиглана.
