...
print("ðŸ”¥ RESEARCHOS â€“ Ð‘Ò®Ð“Ð” ÐÐ­Ð“ Ð”ÐžÐ  Ð¥Ð˜Ð™Ð¥ ÐÐ’Ð¢ÐžÐœÐÐ¢ Ð¡Ð˜Ð¡Ð¢Ð•Ðœ")
print("=" * 50)
print("Loading data...")
...
print("\nðŸ” Validation grid search (parallel)")
...
print("\nðŸ“Š OUT-OF-SAMPLE TEST (2025-2026)")
...
print("âœ… SUCCESS" if res["num_trades"] >= 30 and res["sharpe"] > 0.5 else "âŒ FAILED")
