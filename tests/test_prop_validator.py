...
def test_trading_risk_check_success():
    ...
    result = validator.check_trade_risk(current_balance=10000.0, daily_low_balance=10000.0, risk_amount=50.0, reward_amount=150.0)
...
def test_trading_risk_check_failure_rr():
    validator = TradingRiskCheck(initial_balance=10000.0)
    result = validator.check_trade_risk(current_balance=10000.0, daily_low_balance=10000.0, risk_amount=50.0, reward_amount=50.0)
