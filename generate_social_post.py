...
ax_header.axis('off')
ax_header.text(0.5, 6, "+$220,084", fontsize=48, fontweight='bold', color='#00ff88', ha='left', va='center', fontfamily='monospace')
ax_header.text(0.5, 2.5, "Total Backtest Profit | ResearchOS Engine", fontsize=14, color='#888888', ha='left', va='center')
...
for spine in ax_price.spines.values(): spine.set_color('#222222')
...
for spine in ax_vol.spines.values(): spine.set_color('#222222')
...
for spine in ax_rsi.spines.values(): spine.set_color('#222222')
...
for spine in ax_profit.spines.values(): spine.set_color('#222222')
