...
import sys, time, timeit, statistics, pathlib
...
if p.exists(): print(f"Binary: {p.stat().st_size/1024:.0f}KB (pybind11 was 684KB+26MB PDB)")
...
times=[]
for _ in range(100):
    t0=tm.perf_counter(); b.market_data_load(req); times.append((tm.perf_counter()-t0)*1000)
