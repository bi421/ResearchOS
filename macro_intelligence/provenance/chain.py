...
from macro_intelligence.version import VersionInfo
...
class ProvenanceChain:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {
            ...
            "evidence_references": [
                ref.to_dict() for ref in self.evidence_references
            ],
    ...
    def from_dict(cls, data: dict[str, Any]) -> ProvenanceChain:
        """Deserialize from dictionary."""
        evidence_refs = [
            EvidenceReference.from_dict(ref)
            for ref in data.get("evidence_references", [])
        ]
