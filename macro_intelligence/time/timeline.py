...
class CalendarEvent:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {
            ...
            "actual_time": TimeNormalizer.get_deterministic_timestamp(self.actual_time)
            if self.actual_time
            else None,
            "duration": self.duration.total_seconds() if self.duration else None,
            "is_recurring": self.is_recurring,
            "recurrence_pattern": self.recurrence_pattern,
            "recurrence_end": TimeNormalizer.get_deterministic_timestamp(self.recurrence_end)
    ...
    def from_dict(cls, data: dict[str, Any]) -> CalendarEvent:
        ...
        return cls(
            ...
            recurrence_end=TimeNormalizer.parse_deterministic_timestamp(data["recurrence_end"])
