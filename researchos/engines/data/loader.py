...
Usage:
    from researchos.engines.data.loader import DataLoader
...
from researchos.engines.data.csv_loader import FORMAT_MT5, FORMAT_TRADINGVIEW, CsvLoader
...
class DataLoader:
    ...
    _CONFIG: Dict[str, Dict[str, Any]] = {
        # =========================================================
        # â„ï¸ FROZEN (Legacy) - XAUUSD (Read-only, do not modify)
        # =========================================================
        "xauusd": {
        ...
        # =========================================================
        # ðŸš€ ACTIVE (Development) - Crypto Majors
        # =========================================================
        "btcusdt": {
        ...
        # ðŸ”® Future Junk coins (e.g., pepeusdt) can be added here later
    }
