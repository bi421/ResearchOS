"""
CSV Loader â€” load market data from CSV files into Data Engine objects.
...
Guarantees:
    - Deterministic: Same CSV â†’ same objects (content-addressed IDs)
...
from researchos.engines.data.contracts import CandleField, LoaderConfig, Timeframe
from researchos.engines.data.quote import Quote
from researchos.engines.data.tick import Tick
from researchos.engines.data.timezone import normalize_timestamp
from researchos.engines.data.trade import Trade
