"""
HistoricalDataset â€” collection of market data for a symbol and timeframe.
...
Guarantees:
    - Deterministic: Same data â†’ same dataset hash
...
from researchos.engines.data.contracts import DataQuality, DatasetStatus
from researchos.engines.data.orderbook import OrderBook
