...
from researchos.engines.quant.research_interface import (
    RESEARCH_OPERATIONS,
...
class PythonResearchBackend(ResearchComputationInterface, QuantComputationInterface):
    ...
    def research_technical(self, bars: Any, specs: Sequence[Any], **params: Any) -> ResearchResult:
        from researchos.engines.quant.technical.engine import TechnicalAnalysisEngine
    ...
    def research_portfolio_metrics(
        ...
        **params: Any,
        ...
        from researchos.engines.quant.portfolio.analytics import compute_portfolio_metrics
    ...
    def research_historical(self, returns: Sequence[float], metric: str, **params: Any) -> ResearchResult:
        from researchos.engines.quant.historical.analytics import (
            drawdown_statistics,
            extract_features,
            pattern_frequencies,
            session_statistics,
        ...
        from researchos.engines.quant.historical.contracts import ReturnSeries
    ...
    def research_validation(
        ...
        **params: Any,
        ...
        from researchos.engines.quant.validation.walk_forward import WalkForwardValidator
