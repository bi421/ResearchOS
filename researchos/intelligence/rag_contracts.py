    ...
    def from_dict(cls, data: Dict[str, Any]) -> "RetrievalQuery":
        return cls(
            ...
            timestamp=datetime.fromisoformat(data["timestamp"])
                if isinstance(data.get("timestamp"), str) else data.get("timestamp", datetime.utcnow()),
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "RetrievalContext":
        return cls(
            ...
            session_start=datetime.fromisoformat(data["session_start"])
                if isinstance(data.get("session_start"), str) else data.get("session_start", datetime.utcnow()),
