...
from researchos.macro.features.definitions import FeatureDefinition
from researchos.macro.features.enums import FeatureCategory
...
class FeatureMetadata:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {
            ...
            "last_calculated": (
                TimeNormalizer.get_deterministic_timestamp(self.last_calculated)
