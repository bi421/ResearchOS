...
from researchos.macro.regime.classification.models import (
    ClassificationEvidence,
    ClassificationRule,
    RegimeClassification,
)
from researchos.macro.regime.classification.rules import (
    ALL_RULES,
    RULES_VERSION,
)
from researchos.macro.regime.classification.taxonomy import (
    MacroRegime,
)
...
class RegimeClassifier:
    ...
    def classify_macro_regime(
        ...
        evidence = ClassificationEvidence(
            matching_rule_id=(
                "GI-" + gi_regime.upper()[:3] if gi_regime != "disinflation" else "GI-005"
            ),
