...
class TransitionProbabilityEngine:
    ...
    def get_transition_risk_score(
        ...
        """
        stay_prob = self.get_transition_probability(from_regime, from_regime)
    ...
    def get_stability_score(
        ...
        """
        return round(self.get_transition_probability(from_regime, from_regime), 4)
    ...
    def update_with_observations(
        ...
        """
        self._prior_probs = update_transition_probs(self._prior_probs, observations, alpha)
