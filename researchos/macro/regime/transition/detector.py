...
from researchos.macro.regime.classification.classifier import RegimeClassifier
from researchos.macro.regime.classification.taxonomy import MacroRegime
from researchos.macro.regime.detection.models import RegimeAssessment
from researchos.macro.regime.transition.history import TransitionHistory
from researchos.macro.regime.transition.models import (
    ALGORITHM_VERSION,
    EarlyWarningSignal,
    RegimePersistence,
    RegimeTransition,
...
from researchos.macro.regime.transition.probability import TransitionProbabilityEngine
from researchos.macro.regime.transition.transitions import (
    calculate_continuation_probability,
    classify_transition_type,
    estimate_early_warning_horizon,
    should_generate_early_warning,
)
from researchos.macro.statistics.provenance import content_hash
...
class RegimeTransitionDetector:
    ...
    def detect_transition(
        ...
        # Compute confidence
        confidence = self._compute_transition_confidence(current_assessment, signals)
    ...
    def analyze_transitions(
        ...
        early_warnings = self._detect_early_warnings(current_assessment, current_regime)
        ...
        result = TransitionAnalysisResult(
            ...
            probability_matrix=(
                TransitionProbabilityMatrix.from_dict(prob_matrix) if prob_matrix else None
            ),
