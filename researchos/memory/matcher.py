...
from researchos.memory.similarity import compare_snapshots
...
class ScenarioMatcher:
    ...
    def get_weight_report(self) -> dict[str, object]:
        ...
        return {
            ...
            "description": ("Weighted sum of normalized feature differences. Each feature is normalized to [0,1] and multiplied by its weight. Weights must sum to 1.0. Higher scores indicate greater similarity."),
        }
