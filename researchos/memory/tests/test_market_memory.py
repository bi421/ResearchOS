...
from researchos.memory.events import MacroMarketEvent
...
from researchos.memory.repository import MarketMemoryRepository
from researchos.memory.similarity import (
    compare_snapshots,
