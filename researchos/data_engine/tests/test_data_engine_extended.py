...
from researchos.data_engine.queries import MultiSymbolQuery, RangeQuery
...
class TestQueriesModule:
    ...
    def test_queries_module_is_same_object(self):
        from researchos.data_engine import RangeQuery as RootRangeQuery
...
class TestHashingExtended:
    ...
    def test_range_hash_deterministic(self):
        from researchos.data_engine import compute_range_hash
