"""Script to rewrite evidence.py with clean content."""
evidence_content = '''"""
...
import os
path = os.path.join('C:', os.sep, 'Users', 'User', 'Desktop', 'ResearchOS', 'researchos', 'decision_engine', 'evidence.py')
with open(path, 'w', newline='\n') as f:
    f.write(evidence_content)
print(f'Written {len(evidence_content)} bytes to {path}')
